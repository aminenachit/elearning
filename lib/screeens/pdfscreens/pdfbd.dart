...
class Pdfbd extends StatefulWidget {
  const Pdfbd({super.key});

  @override
  State<Pdfbd> createState() => _Pdfbd();
}

class _Pdfbd extends State<Pdfbd> {
  ...
  Future<String> uploadPdf(String fileName, File file) async {
    final reference =
        FirebaseStorage.instance.ref().child('bd/$fileName.pdf');
  ...
  void pickFile() async {
    ...
    if (pickedFile != null) {
      ...
      _firebaseFirestore.collection("bd").add({
        "name": fileName,
        "url": downloadLink,
      });
  ...
  void getAllPdf() async {
    final results = await _firebaseFirestore.collection("bd").get();
