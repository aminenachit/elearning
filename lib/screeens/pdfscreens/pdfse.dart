...
class Pdfse extends StatefulWidget {
  const Pdfse({super.key});

  @override
  State<Pdfse> createState() => _Pdfse();
}

class _Pdfse extends State<Pdfse> {
  ...
  Future<String> uploadPdf(String fileName, File file) async {
    final reference =
        FirebaseStorage.instance.ref().child('se/$fileName.pdf');
  ...
  void pickFile() async {
    ...
    if (pickedFile != null) {
      ...
      _firebaseFirestore.collection("se").add({
        "name": fileName,
        "url": downloadLink,
      });
  ...
  void getAllPdf() async {
    final results = await _firebaseFirestore.collection("se").get();
