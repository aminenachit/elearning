...
class Pdfma extends StatefulWidget {
  const Pdfma({super.key});

  @override
  State<Pdfma> createState() => _Pdfma();
}

class _Pdfma extends State<Pdfma> {
  ...
  Future<String> uploadPdf(String fileName, File file) async {
    final reference =
        FirebaseStorage.instance.ref().child('ma/$fileName.pdf');
  ...
  void pickFile() async {
    ...
    if (pickedFile != null) {
      ...
      _firebaseFirestore.collection("ma").add({
        "name": fileName,
        "url": downloadLink,
      });
  ...
  void getAllPdf() async {
    final results = await _firebaseFirestore.collection("ma").get();
