...
class Pdfang extends StatefulWidget {
  const Pdfang({super.key});

  @override
  State<Pdfang> createState() => _Pdfang();
}

class _Pdfang extends State<Pdfang> {
  ...
  Future<String> uploadPdf(String fileName, File file) async {
    final reference =
        FirebaseStorage.instance.ref().child('ang/$fileName.pdf');
  ...
  void pickFile() async {
    ...
    if (pickedFile != null) {
      ...
      _firebaseFirestore.collection("ang").add({
        "name": fileName,
        "url": downloadLink,
      });
  ...
  void getAllPdf() async {
    final results = await _firebaseFirestore.collection("ang").get();
